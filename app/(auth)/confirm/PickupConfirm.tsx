...
//       try {
//         const res = await fetch(
//           `https://medilogic-backend.onrender.com/confirm?token=${token}`
//         );

//         if (!res.ok) {
//           throw new Error('Failed to load confirmation data');
//         }
...
//       } catch (err: any) {
//         toast.error(err.message || 'Invalid or expired confirmation link');
//       }
//     };
...
//   <Label>Client Signature (Drawn) *</Label>
//   <Input
//     type="file"
