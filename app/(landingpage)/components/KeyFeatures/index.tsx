  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-7xl">
        <div
          className={`text-center mb-16 ${fadeInUp} ${keyFeaturesInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}
        >
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          {[
            ...
            <Card
              key={index}
              className={`group hover:shadow-2xl transition-all duration-700 border-0 shadow-lg overflow-hidden hover:-translate-y-2 p-0 ${fadeInUp} ${
                keyFeaturesInView
