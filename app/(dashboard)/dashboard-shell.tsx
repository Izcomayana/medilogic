...
//           className="fixed bottom-6 right-6 z-50 h-12 w-12 rounded-full bg-blue-600 hover:bg-blue-500 shadow-lg flex items-center justify-center"
...
//       {/* Chat popup */}
//       {chatOpen && (
//         <div className="fixed bottom-6 right-6 w-80 h-[90vh] bg-gray-800 rounded-lg shadow-lg border border-gray-700 z-50 flex flex-col">
