...
//       } catch (error: any) {
//         // console.error("Failed to fetch organizations:", error);
//         console.error("Failed to fetch organizations:", error.response.data.detail);
//         // setOrgCount(0);
//       }
//     }
...
//       try {
//         const res = await axios.get(
//           "https://medilogic-backend.onrender.com/super/regulators",
//           {
//             headers: {
//               Authorization: `Bearer ${token}`,
//             },
//           },
//         );
//         setRegulatorCount(Array.isArray(res.data) ? res.data.length : 0);
//       } catch (error: any) {
//         console.error("Failed to fetch regulators:", error.response.data.detail);
//         // setRegulatorCount(0);
//       }
//     }
