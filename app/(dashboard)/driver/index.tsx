...
import DateRangeFilter, { DateRangeLocal } from '@/app/(dashboard)/components/DateRange';
...
export const Driver = () => {
      ...
      try {
        ...
        await authorizedRequest(async (token) => {
          const res = await api.get(
            `/dashboard/dashboard/driver/${driverId}`,
            {
              params: {
  ...
  return (
    <div className="bg-gray-900">
      ...
      {/* <PageHeader title="Hello, Michael Scofield 👋" subtitle="Here's your activity overview" /> */}
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <Card className="bg-gray-800 border border-gray-700">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-white">{dashboard.trip_summary.total_trips}</div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-800 border border-gray-700">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-white">{dashboard.trip_summary.completed}</div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-800 border border-gray-700">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-white">{dashboard.trip_summary.in_progress}</div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-800 border border-gray-700">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-white">{dashboard.trip_summary.cancelled}</div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <Card className="bg-gray-800 border border-gray-700">
              ...
              <CardContent>
                ...
                <p className="text-gray-400 text-sm mt-2">6 deliveries this month</p>
              </CardContent>
            </Card>
          </div>
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow className="border-gray-700 hover:bg-gray-800">
                          ...
                          <TableHead className="text-gray-300">Pickup</TableHead>
                          <TableHead className="text-gray-300">Dropoff</TableHead>
                      ...
                      <TableBody>
                        {filteredTrips?.map((trip) => (
                          <TableRow key={trip.id} className="border-gray-700 hover:bg-gray-800">
                            ...
                            <TableCell className="text-gray-300">{trip.pickup}</TableCell>
                            <TableCell className="text-gray-300">{trip.dropoff}</TableCell>
                            <TableCell className="text-gray-300 flex items-center gap-1">
                              <Clock className="h-3 w-3" />
                              {trip.time}
                            </TableCell>
                            <TableCell className="text-gray-300">{trip.client}</TableCell>
                            <TableCell>
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow className="border-gray-700 hover:bg-gray-800">
                          ...
                          <TableHead className="text-gray-300">Shift Time</TableHead>
                      ...
                      <TableBody>
                        {dashboard.upcoming_shifts.map((shift) => (
                          <TableRow key={shift.id} className="border-gray-700 hover:bg-gray-800">
                            <TableCell className="font-medium text-white">{shift.date}</TableCell>
                            <TableCell className="text-gray-300 flex items-center gap-1">
                              <Clock className="h-3 w-3" />
                              {shift.time}
                            </TableCell>
                            ...
                            <TableCell className="text-gray-300">{shift.notes}</TableCell>
                            <TableCell>
