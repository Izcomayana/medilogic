...
// export function useDriverIncidents(mockIncidents: Incident[], mockTrips: any[], incidentTypes: string[]) {
//   const base = useIncidentsBase(mockIncidents);
...
//   const resetForm = () => setFormData({ trip: "", type: "", description: "", photoFile: null });
...
//       reportedAt: "Just now",
//       timestamp: new Date().toISOString().slice(0, 16).replace("T", " "),
//       photoUrl: formData.photoFile ? URL.createObjectURL(formData.photoFile) : null,
//       adminResponse: null,
//       auditHistory: [],
//     };
